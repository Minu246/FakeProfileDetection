...
from sklearn.model_selection import GridSearchCV, learning_curve, train_test_split, cross_val_score, StratifiedKFold
...
def train(X_train,y_train,X_test):
    ...
    title = 'Learning Curves (SVM, $\gamma=%.6f$)' %clf.best_estimator_.gamma
